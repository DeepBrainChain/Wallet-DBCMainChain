  ...
  types: [
    {
      ...
      types: {
        ...
        LiveMachine: {
          bondingMachine: "Vec<MachineId>",
          confirmedMachine: "Vec<MachineId>",
          bookedMachine: "Vec<MachineId>",
          onlineMachine: "Vec<MachineId>",
          fulfillingMachine: "Vec<MachineId>",
          refusedMachine: "Vec<MachineId>",
          rentedMachine: "Vec<MachineId>",
          offlineMachine: "Vec<MachineId>",
          refusedMutHardwareMachine: "Vec<MachineId>",
        },
        StashMachine: {
